...
import ca.openosp.openo.PMmodule.model.HealthSafety;
...
import ca.openosp.openo.PMmodule.service.HealthSafetyManager;
...
import ca.openosp.openo.PMmodule.service.SurveyManager;
import ca.openosp.openo.PMmodule.web.formbean.ClientManagerFormBean;
import ca.openosp.openo.PMmodule.web.formbean.ErConsentFormBean;
...
import ca.openosp.openo.common.dao.CdsClientFormDao;
...
import ca.openosp.openo.common.dao.RemoteReferralDao;
...
import ca.openosp.openo.common.model.CdsClientForm;
...
import ca.openosp.openo.common.model.RemoteReferral;
...
import ca.openosp.openo.managers.RoomDemographicManager;
import ca.openosp.openo.managers.RoomManager;
...
public class ClientManagerAction extends DispatchAction {
    ...
    public ActionForward survey(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        return new ActionForward("/ca/openosp/openo/PMmodule/Forms/SurveyExecute.do?method=survey&formId=" + formId + "&clientId=" + clientId);
    }
