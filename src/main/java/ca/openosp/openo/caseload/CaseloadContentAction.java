...
import ca.openosp.openo.common.dao.CaseloadDao;
        ...
        for (Integer result : demoSearchResult) {
            ...
            if (hasPrivilege("_caseload.DisplayMode", roleName$)) {
                ...
                if (isModuleLoaded(request, "TORONTO_RFQ", true) && hasPrivilege("_appointment.doctorLink", roleName$)) {
                    buttons += "| <a href='#' onClick=\"popupOscarRx(700,1027,'../ehroscarRx/choosePatient.do?providerNo=" + curUser_no + "&demographicNo=" + demographic_no + "');return false;\">Rx</a> ";
                }
