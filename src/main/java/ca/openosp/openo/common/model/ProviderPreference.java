...
public class ProviderPreference extends AbstractModel<String> implements Serializable {
    ...
    /**
     * The URL of the external prescription SSO (Single Sign On) ehrweb service that is used on the ehroscarRx ERx link.
     * <p>
     * FUTURE: Once org.oscarehr.ehroscarRx.erx supports more than one external
     ...
     */
    private String eRx_SSO_URL = OscarProperties.getInstance().getProperty("ehrutil.erx.oscarRx_sso_url");
    /**
     * The provider's username on the external prescription ehrweb service.
     * <p>
     * FUTURE: org.oscarehr.ehroscarRx.erx should, in the future, support more than
    ...
    /**
     * The provider's password on the external prescription ehrweb service.
     * <p>
     * FUTURE: org.oscarehr.ehroscarRx.erx should, in the future, support more than
     * one external prescription service, which may not necessarily require a
    ...
    /**
     * Returns the provider's password on the external prescription ehrweb service.
     *
    ...
    /**
     * Returns the provider's username on the external prescription ehrweb service.
     *
    ...
    /**
     * Returns the URL of the external prescription ehrweb service.
     *
