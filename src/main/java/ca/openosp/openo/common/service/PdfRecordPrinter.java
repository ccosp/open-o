...
public class PdfRecordPrinter {
    ...
    //private static final String OSCAR_LOGO_FILE = "org/oscarehr/common/ehrweb/images/ca.openosp.openo.jpg";
...
*/
    ...
    public void printPhotos(String contextPath, List<ca.openosp.openo.common.model.Document> photos) throws DocumentException {
        writer.setStrictImageSequence(true);
        ...
        for (ca.openosp.openo.common.model.Document doc : photos) {
            Image img = null;
            try {
