 ...
 * be renamed to org.oscarehr.ehroscarRx.erx.model.DoctorPreferences;
 * which should implement a new interface named
 * ca.openosp.openo.model.erx.ehroscarRx.ERxDoctorPreferences. This new interface should
 ...
 * org.oscarehr.ehroscarRx.erx.model.DoctorPreferences should be
 * re-factored as such.
 */
public class ERxDoctorPreferences {
    ...
    /**
     * The doctor's username, which will be used to connect to the ehrweb service.
    ...
    /**
     * The doctor's password, which will be used to connect to the ehrweb service.
     ...
     * @param connectionURL    The URL of the ehrweb service to connect to.
    ...
    /**
     * Returns the URL of the ehrweb service to connect to.
     *
    ...
    /**
     * Returns the doctor's password, which will be used to connect to the ehrweb
     * service.
     *
    ...
    /**
     * Returns the doctor's username, which will be used to connect to the ehrweb
     * service.
     *
    ...
    /**
     * Changes the value of the URL of the ehrweb service to connect to.
     *
