...
package ca.openosp.openo.ehroscarRx.erx.model;
 ...
 * <p>
 * FUTURE: org.oscarehr.ehroscarRx.erx should, in the future, support more than one
 ...
 * org.oscarehr.ehroscarRx.erx.model.FacilityPreferences; which should
 * implement a new interface named
 * ca.openosp.openo.model.erx.ehroscarRx.ERxFacilityPreferences. This new interface
 ...
 * org.oscarehr.ehroscarRx.erx.model.FacilityPreferences should be
 * re-factored as such.
 */
public class ERxFacilityPreferences {
    ...
    /**
     * The URL of the ehrweb service to connect to, provided by the External Prescriber.
     */
    private URL remoteURL;
    /**
     * The facility's username, which will be used to connect to the ehrweb service
     * and is provided by the External Prescriber.
     */
    private String username;
    /**
     * The facility's password, which will be used to connect to the ehrweb service
     * and is provided by the External Prescriber.
     */
     ...
     * @param remoteURL    The URL of the ehrweb service to connect to, provided by the External Prescriber.
     * @param username     The facility's username, which will be used to connect to the
     *                     ehrweb service and is provided by the External Prescriber.
    ...
    /**
     * Returns the facility's password, which will be used to connect to the ehrweb
    ...
    /**
     * Returns the URL of the ehrweb service to connect to, provided by the External Prescriber.
     *
    ...
    /**
     * Returns the facility's username, which will be used to connect to the ehrweb
     * service and is provided by the External Prescriber.
     *
     ...
     * connect to the ehrweb service and is provided by the External Prescriber.
     *
    ...
    /**
     * Changes the value of the URL of the ehrweb service to connect to, provided
     * by the External Prescriber.
     *
