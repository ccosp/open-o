...
/**
 * Represents a WSResult5 ID number used by the External Prescriber ehrweb services to indicate the
...
public enum WSResult5 {
     ...
     * in the External Prescriber's ehrweb service (i.e.: System Error).
     */
    ERROR_UNMANAGED(4),
    /**
