 ...
 * be called by sending a SOAP request to the External Prescriber's ehrweb service.
 *
 * @see <a
 * href="https://the External Prescriber.org:5201/oscar/ZRxPMISBridge/PMISBridge.asmx?op=SetPatientImmediate3">The
 * the External Prescriber SetPatientImmediate3 ehrweb service demo page</a>
 * @see <a
