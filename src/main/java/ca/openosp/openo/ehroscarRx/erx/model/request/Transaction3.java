...
package ca.openosp.openo.ehroscarRx.erx.model.request;
...
/**
 * A value type that stores data about a single ehrweb transaction with the External Prescriber.
 * <p>
 ...
 * the External Prescriber GetPrescriptions5 ehrweb services demo page</a>
 * @see <a
...
public class Transaction3 {
    /**
     * Formats dates in a way that the the External Prescriber ehrweb services can understand.
     *
    ...
    /**
     * The name of the software connecting to the ehrweb service.
     */
    ...
    /**
     * The version of the software connecting to the ehrweb service.
     */
     ...
     *                                       debugging purposes.
     * @param engine                         The name of the software connecting to the ehrweb service.
     * @param sender                         The name of the software vendor that created the software
     *                                       connecting to the ehrweb service.
     * @param version                        The version of the software connecting to the ehrweb service.
