 ...
 * which is returned by the External Prescriber's ehrweb service after sending a prescription
 * request to it.
 */
public class GetPrescriptions5Response {
     ...
     * from the remote ehrweb service if necessary, and returning a list of
     ...
     *                                  could recognize.
     * @throws SecurityException        Re-throws a SecurityException if the remote ehrweb servcice
