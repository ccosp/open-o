 ...
 * returned by the External Prescriber's ehrweb service as part of a GetPrescriptions5Result.
 */
public class Result {
    /**
     * The result code.
    ...
    /**
     * The URL of the ehrweb service reporting the result.
     */
    private URL url;
     ...
     * @param url         The URL of the ehrweb service reporting the result.
     */
