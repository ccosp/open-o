...
package ca.openosp.openo.ehroscarRx.erx.model.response;

import javax.naming.ServiceUnavailableException;

import ca.openosp.openo.ehroscarRx.erx.model.WSPatientResult3;
 ...
 * which is returned by the External Prescriber's ehrweb service after sending patient data to it.
 */
public class SetPatientImmediate3Result {
     ...
     * from the remote ehrweb service if necessary.
     *
     ...
     * @throws IllegalArgumentException Re-throws an IllegalArgumentException if the remote ehrweb
     *                                  service reports that it didn't receive data in a format it
     *                                  could recognize.
     * @throws SecurityException        Re-throws a SecurityException if the remote ehrweb service
     *                                  reports a security-related error.
     * @throws Exception                Re-throws an Exception if the remote ehrweb service reports an
    ...
    public static void parseSetPatientImmediate3Result(Node node)
        ...
        // Parse the node to see if the ehrweb service returned errors
