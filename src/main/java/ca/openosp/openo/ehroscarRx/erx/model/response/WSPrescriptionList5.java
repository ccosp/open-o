...
import ca.openosp.openo.ehroscarRx.erx.model.WSResult5;
 ...
 * returned by the External Prescriber's ehrweb service after sending a prescription request to it.
 */
public class WSPrescriptionList5 {
    /**
     * Parse a the External Prescriber WSPrescriptionList5 document, re-throwing errors from the
     * remote ehrweb service if necessary, and returning a list of WSPrescription5
     * nodes.
     *
