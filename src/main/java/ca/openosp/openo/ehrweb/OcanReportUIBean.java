...
import ca.openosp.openo.common.dao.OcanConnexOptionDao;
...
import ca.openosp.openo.common.model.OcanClientFormData;
import ca.openosp.openo.common.model.OcanStaffForm;
import ca.openosp.openo.common.model.OcanStaffFormData;
import ca.openosp.openo.ocan.AboriginalOriginDocument.AboriginalOrigin;
import ca.openosp.openo.ocan.AcceptedDocument.Accepted;
import ca.openosp.openo.ocan.*;
import ca.openosp.openo.ocan.ActionDocument.Action;
import ca.openosp.openo.ocan.ActionListDocument.ActionList;
import ca.openosp.openo.ocan.AddictionTypeDocument.AddictionType;
import ca.openosp.openo.ocan.AddictionTypeListDocument.AddictionTypeList;
import ca.openosp.openo.ocan.AdditionalElementsDocument.AdditionalElements;
import ca.openosp.openo.ocan.AgeHospitalizationDocument.AgeHospitalization;
import ca.openosp.openo.ocan.AgeOnsetMentalDocument.AgeOnsetMental;
import ca.openosp.openo.ocan.AreasOfConcernDocument.AreasOfConcern;
import ca.openosp.openo.ocan.BarriersFindingWorkDocument.BarriersFindingWork;
import ca.openosp.openo.ocan.BarriersFindingWorkListDocument.BarriersFindingWorkList;
import ca.openosp.openo.ocan.ChangedSocialPatternsDocument.ChangedSocialPatterns;
import ca.openosp.openo.ocan.CitizenshipStatusDocument.CitizenshipStatus;
import ca.openosp.openo.ocan.ClientAddressDocument.ClientAddress;
import ca.openosp.openo.ocan.ClientCapacityDocument.ClientCapacity;
import ca.openosp.openo.ocan.ClientContactDocument.ClientContact;
import ca.openosp.openo.ocan.ClientCultureDocument.ClientCulture;
import ca.openosp.openo.ocan.ClientCultureHeritageImportanceDocument.ClientCultureHeritageImportance;
import ca.openosp.openo.ocan.ClientDOBDocument.ClientDOB;
import ca.openosp.openo.ocan.ClientHealthCardInfoDocument.ClientHealthCardInfo;
import ca.openosp.openo.ocan.ClientHopesForFutureDocument.ClientHopesForFuture;
import ca.openosp.openo.ocan.ClientIDDocument.ClientID;
import ca.openosp.openo.ocan.ClientNameDocument.ClientName;
import ca.openosp.openo.ocan.ClientNeedToGetThereDocument.ClientNeedToGetThere;
import ca.openosp.openo.ocan.ClientPhoneDocument.ClientPhone;
import ca.openosp.openo.ocan.ClientRecordDocument.ClientRecord;
import ca.openosp.openo.ocan.ClientSpiritualityImportanceDocument.ClientSpiritualityImportance;
import ca.openosp.openo.ocan.ClientViewMentalHealthDocument.ClientViewMentalHealth;
import ca.openosp.openo.ocan.CommunityTreatOrderDocument.CommunityTreatOrder;
import ca.openosp.openo.ocan.CompletedByOCANLeadDocument.CompletedByOCANLead;
import ca.openosp.openo.ocan.ConcernAreaDocument.ConcernArea;
import ca.openosp.openo.ocan.ConcernAreaListDocument.ConcernAreaList;
import ca.openosp.openo.ocan.ConsumerSelfAxCompletedDocument.ConsumerSelfAxCompleted;
import ca.openosp.openo.ocan.ContactInfoDocument.ContactInfo;
import ca.openosp.openo.ocan.DiagnosticDocument.Diagnostic;
import ca.openosp.openo.ocan.DiagnosticListDocument.DiagnosticList;
import ca.openosp.openo.ocan.DiscrimExpListDocument.DiscrimExpList;
import ca.openosp.openo.ocan.DoctorContactDocument.DoctorContact;
import ca.openosp.openo.ocan.DomainActionsDocument.DomainActions;
import ca.openosp.openo.ocan.DomainCommentsDocument.DomainComments;
import ca.openosp.openo.ocan.DomainDocument.Domain;
import ca.openosp.openo.ocan.DrinkAlcoholDocument.DrinkAlcohol;
import ca.openosp.openo.ocan.DrugUseDocument.DrugUse;
import ca.openosp.openo.ocan.DrugUseListDocument.DrugUseList;
import ca.openosp.openo.ocan.EducationProgramStatusDocument.EducationProgramStatus;
import ca.openosp.openo.ocan.EmployStatusDocument.EmployStatus;
import ca.openosp.openo.ocan.ExitDispositionDocument.ExitDisposition;
import ca.openosp.openo.ocan.FirstEntryDateDocument.FirstEntryDate;
import ca.openosp.openo.ocan.FormalHelpNeedDocument.FormalHelpNeed;
import ca.openosp.openo.ocan.FormalHelpRecvdDocument.FormalHelpRecvd;
import ca.openosp.openo.ocan.GenderDocument.Gender;
import ca.openosp.openo.ocan.HighestEducationLevelDocument.HighestEducationLevel;
import ca.openosp.openo.ocan.HospitalizedPastTwoYearsDocument.HospitalizedPastTwoYears;
import ca.openosp.openo.ocan.ImmigExpListDocument.ImmigExpList;
import ca.openosp.openo.ocan.InformalHelpRecvdDocument.InformalHelpRecvd;
import ca.openosp.openo.ocan.LegalGuardianDocument.LegalGuardian;
import ca.openosp.openo.ocan.LegalIssuesDocument.LegalIssues;
import ca.openosp.openo.ocan.LegalStatusDocument.LegalStatus;
import ca.openosp.openo.ocan.LegalStatusListDocument.LegalStatusList;
import ca.openosp.openo.ocan.LivingArrangementTypeDocument.LivingArrangementType;
import ca.openosp.openo.ocan.MISFunctionDocument.MISFunction;
import ca.openosp.openo.ocan.MaritalStatusDocument.MaritalStatus;
import ca.openosp.openo.ocan.MedicalConditionDocument.MedicalCondition;
import ca.openosp.openo.ocan.MedicalConditionListDocument.MedicalConditionList;
import ca.openosp.openo.ocan.MedicationDetailDocument.MedicationDetail;
import ca.openosp.openo.ocan.MedicationListDocument.MedicationList;
import ca.openosp.openo.ocan.NeedRatingDocument.NeedRating;
import ca.openosp.openo.ocan.OCANDomainsDocument.OCANDomains;
import ca.openosp.openo.ocan.OCANLeadDocument.OCANLead;
import ca.openosp.openo.ocan.OCANv2SubmissionFileDocument.OCANv2SubmissionFile;
import ca.openosp.openo.ocan.OCANv2SubmissionRecordDocument.OCANv2SubmissionRecord;
import ca.openosp.openo.ocan.OtherAgencyContactDocument.OtherAgencyContact;
import ca.openosp.openo.ocan.OtherIllnessDocument.OtherIllness;
import ca.openosp.openo.ocan.OtherIllnessListDocument.OtherIllnessList;
import ca.openosp.openo.ocan.OtherPractitionerContactDocument.OtherPractitionerContact;
import ca.openosp.openo.ocan.PhysicalHealthConcernDocument.PhysicalHealthConcern;
import ca.openosp.openo.ocan.PowerAttorneyPersonalCareDocument.PowerAttorneyPersonalCare;
import ca.openosp.openo.ocan.PowerAttorneyPropertyDocument.PowerAttorneyProperty;
import ca.openosp.openo.ocan.PrefLangDocument.PrefLang;
import ca.openosp.openo.ocan.PresentingIssueDocument.PresentingIssue;
import ca.openosp.openo.ocan.PresentingIssueListDocument.PresentingIssueList;
import ca.openosp.openo.ocan.ProgramDocument.Program;
import ca.openosp.openo.ocan.PsychiatristContactDocument.PsychiatristContact;
import ca.openosp.openo.ocan.ReasonConsumerSelfAxNotCompletedListDocument.ReasonConsumerSelfAxNotCompletedList;
import ca.openosp.openo.ocan.ReasonForOCANDocument.ReasonForOCAN;
import ca.openosp.openo.ocan.ReferralDocument.Referral;
import ca.openosp.openo.ocan.ReferralListDocument.ReferralList;
import ca.openosp.openo.ocan.ReferralSourceDocument.ReferralSource;
import ca.openosp.openo.ocan.ResidenceSupportDocument.ResidenceSupport;
import ca.openosp.openo.ocan.ResidenceTypeDocument.ResidenceType;
import ca.openosp.openo.ocan.SafetyConcernSelfDocument.SafetyConcernSelf;
import ca.openosp.openo.ocan.SafetyToSelfRiskDocument.SafetyToSelfRisk;
import ca.openosp.openo.ocan.SafetyToSelfRiskListDocument.SafetyToSelfRiskList;
import ca.openosp.openo.ocan.ServiceDeliveryLHINDocument.ServiceDeliveryLHIN;
import ca.openosp.openo.ocan.ServiceLangDocument.ServiceLang;
import ca.openosp.openo.ocan.ServiceOrgDocument.ServiceOrg;
import ca.openosp.openo.ocan.ServiceRecipientLHINDocument.ServiceRecipientLHIN;
import ca.openosp.openo.ocan.ServiceRecipientLocationDocument.ServiceRecipientLocation;
import ca.openosp.openo.ocan.ServiceUseRecordDocument.ServiceUseRecord;
import ca.openosp.openo.ocan.ServiceUseRecordListDocument.ServiceUseRecordList;
...
import ca.openosp.openo.ocan.SuicideAttemptDocument.SuicideAttempt;
import ca.openosp.openo.ocan.SuicideThoughtsDocument.SuicideThoughts;
import ca.openosp.openo.ocan.SymptomDocument.Symptom;
import ca.openosp.openo.ocan.SymptomListDocument.SymptomList;
import ca.openosp.openo.ocan.TimeLivedInCanadaDocument.TimeLivedInCanada;
import ca.openosp.openo.ocan.VisitEmergencyDepartmentDocument.VisitEmergencyDepartment;
import ca.openosp.openo.ehrutil.CxfClientUtils;
