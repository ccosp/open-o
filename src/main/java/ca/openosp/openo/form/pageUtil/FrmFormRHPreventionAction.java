...
import ca.openosp.openo.oscarWorkflow.WorkFlow;
import ca.openosp.openo.oscarWorkflow.WorkFlowFactory;
import ca.openosp.openo.oscarWorkflow.WorkFlowState;
...
public class FrmFormRHPreventionAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        // <action path="/form/AddRHWorkFlow" scope="request" name="FrmForm" type="ca.openosp.openo.pageUtil.form.FrmFormAddRHWorkFlowAction">
