...
import ca.openosp.openo.oscarEncounter.data.EctEChartBean;
import ca.openosp.openo.oscarEncounter.oscarMeasurements.bean.EctMeasurementTypesBean;
import ca.openosp.openo.oscarEncounter.oscarMeasurements.util.EctFindMeasurementTypeUtil;
...
public final class FrmSetupFormAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/*catch (Exception e) {
            ...
            MiscUtils.getLogger().debug("This file must be placed at ehrweb/form");
            MiscUtils.getLogger().error("Error", e);
        }
