...
java -classpath .:%CLASSPATH% ca.openosp.openo.study.form.FrmStudyXMLClientSend /root/oscar_sfhc.properties https://67.69.12.115:8443/OscarComm/DummyReceiver
java -classpath .:%CLASSPATH% ca.openosp.openo.study.form.FrmStudyXMLClientSend /root/oscar_sfhc.properties https://192.168.42.180:15000/ /root/oscarComm/oscarComm.keystore

java -classpath .:%CLASSPATH% ca.openosp.openo.study.form.FrmStudyXMLClientSend /root/oscar_sfhc.properties https://130.113.150.203:15501/ /root/oscarComm/enleague.keystore
java -classpath .:%CLASSPATH% ca.openosp.openo.study.form.FrmStudyXMLClientSend /root/oscar_sfhc.properties https://192.168.42.180:15000/ /root/oscarComm/compete.keystore
java ca.openosp.openo.study.form.FrmStudyXMLClientSend c:\\root\\oscar_sfhc.properties https://67.69.12.115:8443/OscarComm/DummyReceiver
*/
...
public class FrmStudyXMLClientSend {
    ...
    private synchronized void getStudyContent() throws java.sql.SQLException {
        ...
        while (rs.next()) {
            studyContent.add(Misc.getString(rs, "content"));
            studyNo.add(Misc.getString(rs, "studydata_no"));
        }
        rs.close();
    }
