...
package ca.openosp.openo.form.study.HSFO;
    ...
    public RecommitSchedule getLastSchedule(boolean statusFlag) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                reSchedule.setStatus(Misc.getString(rs, "status"));
                reSchedule.setMemo(Misc.getString(rs, "memo"));
                reSchedule.setSchedule_time(sf.parse(Misc.getString(rs, "schedule_time")));
                reSchedule.setUser_no(Misc.getString(rs, "user_no"));
