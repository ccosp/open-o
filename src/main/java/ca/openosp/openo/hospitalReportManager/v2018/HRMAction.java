...
import ca.openosp.openo.common.dao.HrmLogDao;
import ca.openosp.openo.common.dao.HrmLogEntryDao;
import ca.openosp.openo.common.dao.OscarJobDao;
import ca.openosp.openo.common.dao.OscarJobTypeDao;
import ca.openosp.openo.common.dao.UserPropertyDAO;
import ca.openosp.openo.common.jobs.OscarJobUtils;
import ca.openosp.openo.common.model.HrmLog;
import ca.openosp.openo.common.model.HrmLogEntry;
import ca.openosp.openo.common.model.OscarJob;
import ca.openosp.openo.common.model.OscarJobType;
...
public class HRMAction extends DispatchAction {
    ...
    private void savePolling(LoggedInInfo loggedInInfo, boolean enabled, int frequencyInMinutes) {
        ...
        List<OscarJobType> jobTypes = oscarJobTypeDao.findByClassName("ca.openosp.openo.v2018.hospitalReportManager.HRMDownloadJob");
        if (jobTypes.isEmpty()) {
            oscarJobType = new OscarJobType();
            oscarJobType.setClassName("ca.openosp.openo.v2018.hospitalReportManager.HRMDownloadJob");
