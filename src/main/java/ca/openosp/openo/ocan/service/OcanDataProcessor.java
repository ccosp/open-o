...
package ca.openosp.openo.ocan.service;
...
import ca.openosp.openo.ocan.domain.client.AnswerGroup;
import ca.openosp.openo.ocan.domain.client.OCANClientSelfAssessment;
import ca.openosp.openo.ocan.domain.staff.CCommunityTreatmentOrder;
import ca.openosp.openo.ocan.domain.staff.CIfYesPleaseIndicateTheAreasWhereYouHaveConcernsCheckAllThatApply;
import ca.openosp.openo.ocan.domain.staff.CMedicalConditionsCheckAllThatApply;
import ca.openosp.openo.ocan.domain.staff.COtherContact;
import ca.openosp.openo.ocan.domain.staff.CPsychiatricHistory;
import ca.openosp.openo.ocan.domain.staff.CWhichOfTheFollowingDrugsHaveYouUsedCheckAllThatApply;
import ca.openosp.openo.ocan.domain.staff.OCANStaffAssessment;
import ca.openosp.openo.ocan.domain.submission.Action;
import ca.openosp.openo.ocan.domain.submission.ActionList;
import ca.openosp.openo.ocan.domain.submission.AddictionTypeList;
import ca.openosp.openo.ocan.domain.submission.AdditionalElements;
import ca.openosp.openo.ocan.domain.submission.ClientAddress;
import ca.openosp.openo.ocan.domain.submission.ClientCapacity;
import ca.openosp.openo.ocan.domain.submission.ClientContact;
import ca.openosp.openo.ocan.domain.submission.ClientID;
import ca.openosp.openo.ocan.domain.submission.ClientName;
import ca.openosp.openo.ocan.domain.submission.ClientOHIP;
import ca.openosp.openo.ocan.domain.submission.ClientRecord;
import ca.openosp.openo.ocan.domain.submission.ConcernAreaList;
import ca.openosp.openo.ocan.domain.submission.DiagnosticList;
import ca.openosp.openo.ocan.domain.submission.DiscrimExpList;
import ca.openosp.openo.ocan.domain.submission.DoctorContact;
import ca.openosp.openo.ocan.domain.submission.Domain;
import ca.openosp.openo.ocan.domain.submission.DrinkAlcohol;
import ca.openosp.openo.ocan.domain.submission.DrugUse;
import ca.openosp.openo.ocan.domain.submission.DrugUseList;
import ca.openosp.openo.ocan.domain.submission.FormalHelpNeed;
import ca.openosp.openo.ocan.domain.submission.FormalHelpRecvd;
import ca.openosp.openo.ocan.domain.submission.ImmigExpList;
import ca.openosp.openo.ocan.domain.submission.InformalHelpRecvd;
import ca.openosp.openo.ocan.domain.submission.LegalStatusList;
import ca.openosp.openo.ocan.domain.submission.MISFunction;
import ca.openosp.openo.ocan.domain.submission.MedicalConditionList;
import ca.openosp.openo.ocan.domain.submission.MedicationDetail;
import ca.openosp.openo.ocan.domain.submission.MedicationList;
import ca.openosp.openo.ocan.domain.submission.NeedRating;
import ca.openosp.openo.ocan.domain.submission.OCANDomains;
import ca.openosp.openo.ocan.domain.submission.OCANSubmissionFile;
import ca.openosp.openo.ocan.domain.submission.OCANSubmissionRecord;
import ca.openosp.openo.ocan.domain.submission.ObjectFactory;
import ca.openosp.openo.ocan.domain.submission.OrganizationRecord;
import ca.openosp.openo.ocan.domain.submission.OtherAgencyContact;
import ca.openosp.openo.ocan.domain.submission.OtherIllnessList;
import ca.openosp.openo.ocan.domain.submission.OtherPractitionerContact;
import ca.openosp.openo.ocan.domain.submission.PresentingIssue;
import ca.openosp.openo.ocan.domain.submission.PresentingIssueList;
import ca.openosp.openo.ocan.domain.submission.Program;
import ca.openosp.openo.ocan.domain.submission.PsychiatristContact;
import ca.openosp.openo.ocan.domain.submission.ReasonForAssessment;
import ca.openosp.openo.ocan.domain.submission.Referral;
import ca.openosp.openo.ocan.domain.submission.ReferralList;
import ca.openosp.openo.ocan.domain.submission.RiskUnemploymentList;
import ca.openosp.openo.ocan.domain.submission.SafetyToSelfRiskList;
import ca.openosp.openo.ocan.domain.submission.ServiceOrg;
import ca.openosp.openo.ocan.domain.submission.SideEffectsDetailList;
import ca.openosp.openo.ocan.domain.submission.SymptomList;
import ca.openosp.openo.ocan.domain.submission.TimeLivedInCanada;
...
//		ae.setClientCultureHeritageImportance(client.getCQuestions().getCPleaseWriteAFewSentencesToAnswerTheFollowingQuestions().getCIsCultureHeritageAnImportantPartOfYourLife());
    ...
    private void marshal(Object doc, String name) throws FileNotFoundException, JAXBException {
        ...
        JAXBContext jc = JAXBContext.newInstance("ca.openosp.openo.ocan.domain.submission"
