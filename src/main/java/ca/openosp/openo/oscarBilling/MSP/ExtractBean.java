        ...
        try {
            ...
            if (rs != null) {
                while (rs.next()) {
                    ...
                    //    referralDoc = "000000";
                    //    hcFlag = "";
                    //    referral = ca.openosp.openo.SxmlMisc.getXmlContent(rs.getString("content"),"<xml_referral>","</xml_referral>");
                    //    hcType = ca.openosp.openo.SxmlMisc.getXmlContent(rs.getString("content"),"<hctype>","</hctype>");
                    //    m_review = ca.openosp.openo.SxmlMisc.getXmlContent(rs.getString("content"),"<mreview>","</mreview>");
                    ...
                    //   else{
                    //		 demoSex = ca.openosp.openo.SxmlMisc.getXmlContent(rs.getString("content"),"<demosex>","</demosex>");
                    //		 hcFlag = "H";
                    ...
                    //    referralDoc = ca.openosp.openo.SxmlMisc.getXmlContent(rs.getString("content"),"<rdohip>","</rdohip>");
