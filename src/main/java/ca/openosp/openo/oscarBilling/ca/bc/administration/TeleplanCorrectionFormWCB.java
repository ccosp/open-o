...
public class TeleplanCorrectionFormWCB
    ...
    public String[] getWcb(LoggedInInfo loggedInInfo, String billamt) {
        ...
        return new String[]{
                ...
                demo.getFirstName(),//ca.openosp.openo.Misc.mysqlEscape(this.firstName),  //
                demo.getLastName(),//ca.openosp.openo.Misc.mysqlEscape(this.lastName), //
                "",//ca.openosp.openo.Misc.mysqlEscape(this.w_mname),//
                demo.getSex(),//ca.openosp.openo.Misc.mysqlEscape(this.w_gender),//
                DemographicData.getDob(demo, "-"),//ca.openosp.openo.Misc.mysqlEscape(this.DateOfBirth()),//
                demo.getAddress(),//ca.openosp.openo.Misc.mysqlEscape(this.address),  //
                demo.getCity(),//ca.openosp.openo.Misc.mysqlEscape(this.city),  //
                demo.getPostal(),//ca.openosp.openo.Misc.mysqlEscape(this.postal), //
                Misc.areaCode(demo.getPhone2()),//ca.openosp.openo.Misc.mysqlEscape(this.w_area),//
                Misc.phoneNumber(demo.getPhone2()),//ca.openosp.openo.Misc.mysqlEscape(this.w_phone),//
                demo.getHin() + demo.getVer(),//ca.openosp.openo.Misc.mysqlEscape(this.hin),  //
