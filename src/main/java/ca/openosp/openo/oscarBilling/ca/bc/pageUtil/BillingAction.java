...
//        bean = (ca.openosp.openo.pageUtil.bc.ca.oscarBilling.BillingSessionBean) request.getSession().getAttribute("billingSessionBean");
...
//       */
//      else {
//        bean = (ca.openosp.openo.pageUtil.bc.ca.oscarBilling.BillingSessionBean) request.
