...
public final class BillingViewAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        if (oscarVars.getProperty("billregion").equals("ON")) {
            ...
            BillingBillingManager bmanager;
            ...
            //{
            //    bean = new ca.openosp.openo.pageUtil.oscarBilling.BillingSessionBean();
            ...
            //else
            //{
            //    bean = (ca.openosp.openo.pageUtil.oscarBilling.BillingSessionBean)request.getSession().getAttribute("billingSessionBean");
            //}
