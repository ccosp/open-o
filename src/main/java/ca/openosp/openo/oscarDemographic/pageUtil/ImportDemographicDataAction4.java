...
import ca.openosp.openo.common.dao.DocumentExtraReviewerDao;
...
import ca.openosp.openo.common.model.DocumentExtraReviewer;
...
import ca.openosp.openo.oscarLab.LabRequestReportLink;
...
import ca.openosp.openo.oscarLab.ca.all.upload.handlers.CMLHandler;
import ca.openosp.openo.oscarLab.ca.all.upload.handlers.GDMLHandler;
import ca.openosp.openo.oscarLab.ca.all.upload.handlers.MDSHandler;
...
import ca.openosp.openo.oscarRx.data.RxDrugData;
import ca.openosp.openo.oscarRx.data.RxDrugData.DrugMonograph;
...
//                    	preventionType = mapPreventionTypeByCode(immuArray[i].getImmunizationCode());
    ...
    String updateExternalProvider(String firstName, String lastName, String ohipNo, String cpsoNo, ProviderData pd) {
        ...
        ca.openosp.openo.common.model.ProviderData newpd = providerDataDao.findByProviderNo(pd.getProviderNo());
