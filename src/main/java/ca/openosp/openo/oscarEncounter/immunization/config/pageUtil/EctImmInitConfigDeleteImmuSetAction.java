...
package ca.openosp.openo.oscarEncounter.immunization.config.pageUtil;
...
import ca.openosp.openo.oscarEncounter.immunization.config.data.EctImmImmunizationSetData;
