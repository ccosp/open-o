...
package ca.openosp.openo.oscarEncounter.oscarMeasurements;
...
import ca.openosp.openo.oscarEncounter.oscarMeasurements.data.ExportMeasurementType;
import ca.openosp.openo.oscarEncounter.oscarMeasurements.data.ImportMeasurementTypes;
import ca.openosp.openo.oscarEncounter.oscarMeasurements.util.DSCondition;
import ca.openosp.openo.oscarEncounter.oscarMeasurements.util.Recommendation;
import ca.openosp.openo.oscarEncounter.oscarMeasurements.util.RuleBaseCreator;
import ca.openosp.openo.oscarEncounter.oscarMeasurements.util.TargetColour;
...
*/
    protected Element getRuleBaseElement(String ruleName, String measurement, Hashtable<String, String> recowarn) {
        ...
        Element ruleElement = rcb.getRule(ruleName, "ca.openosp.openo.oscarMeasurements.oscarEncounter.MeasurementInfo", list, consequence);
