...
public class RuleBaseCreator {
    ...
    public void test() {
        ...
        Element ruleElement = getRule("REBG1", "ca.openosp.openo.oscarMeasurements.oscarEncounter.MeasurementInfo", list, "MiscUtils.getLogger().debug(\"REBG 1 getting called\");");
        elementList.add(ruleElement);

        list = new ArrayList();
        list.add(new DSCondition("getLastDateRecordedInMonths", "REBG", ">", "6"));
        ruleElement = getRule("REBG2", "ca.openosp.openo.oscarMeasurements.oscarEncounter.MeasurementInfo", list, "MiscUtils.getLogger().debug(\"REBG 1 getting called\");");
        elementList.add(ruleElement);

        list = new ArrayList();
        list.add(new DSCondition("getLastDateRecordedInMonths", "REBG", "==", "-1"));
        ruleElement = getRule("REBG3", "ca.openosp.openo.oscarMeasurements.oscarEncounter.MeasurementInfo", list, "MiscUtils.getLogger().debug(\"REBG 1 getting called\");");
        elementList.add(ruleElement);
    }
