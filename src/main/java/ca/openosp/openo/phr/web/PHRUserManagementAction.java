...
import ca.openosp.openo.myoscar_server.ws.Role;
import ca.openosp.openo.phr.RegistrationHelper;
import ca.openosp.openo.phr.dao.PHRActionDAO;
import ca.openosp.openo.phr.dao.PHRDocumentDAO;
import ca.openosp.openo.phr.indivo.service.accesspolicies.IndivoAPService;
import ca.openosp.openo.phr.model.PHRAction;
...
public class PHRUserManagementAction extends DispatchAction {
    ...
    public ActionForward registerUser(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            ca.openosp.openo.common.model.Document document = new ca.openosp.openo.common.model.Document();
