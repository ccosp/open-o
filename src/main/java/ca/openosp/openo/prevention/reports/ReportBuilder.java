...
import ca.openosp.openo.ws.rest.to.model.PreventionSearchConfigTo1;
...
public class ReportBuilder {
    ...
    private List<Integer> getDemographicDenominator(LoggedInInfo loggedInInfo, PreventionSearchTo1 frm, String provider) {
        ...
        // is this needed ??? oscar.oscarMessenger.ehrutil.MsgStringQuote s = new oscar.oscarMessenger.ehrutil.MsgStringQuote();
