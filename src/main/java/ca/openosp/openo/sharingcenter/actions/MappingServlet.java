...
import ca.openosp.openo.sharingcenter.model.MappingCode;
...
import ca.openosp.openo.sharingcenter.model.CodeValueDataObject;
...
public class MappingServlet extends Action {
    ...
    private MappingCode createCode(String attribute, String displayName, String source, AffinityDomainDataObject network) {
        MappingCode retVal = null;
