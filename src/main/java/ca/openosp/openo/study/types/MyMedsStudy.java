 ...
 * Ontario, Canada
 */
package ca.openosp.openo.study.types;
...
import ca.openosp.openo.study.Study;
import ca.openosp.openo.study.decisionSupport.StudyGuidelines;
...
public class MyMedsStudy implements Study {
    ...
    public boolean isActive() {
        ...
        ca.openosp.openo.common.model.Study study = studyDao.findByName(Study.MYMEDS);
