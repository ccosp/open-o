...
package ca.openosp.openo.survey.web;
...
import ca.openosp.openo.survey.service.OscarFormManager;
import ca.openosp.openo.survey.service.SurveyLaunchManager;
import ca.openosp.openo.survey.service.SurveyManager;
import ca.openosp.openo.survey.service.SurveyModelManager;
import ca.openosp.openo.survey.service.SurveyTestManager;
import ca.openosp.openo.survey.service.UserManager;
import ca.openosp.openo.survey.web.formbean.PageNavEntry;
import ca.openosp.openo.survey.web.formbean.SurveyManagerFormBean;
import ca.openosp.openo.surveymodel.DateDocument;
import ca.openosp.openo.surveymodel.DateDocument.Date.Enum;
import ca.openosp.openo.surveymodel.Page;
import ca.openosp.openo.surveymodel.PossibleAnswersDocument.PossibleAnswers;
...
public class SurveyManagerAction extends AbstractSurveyAction {
    ...
    public ActionForward new_survey(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        surveyForm.set("ehrweb", new SurveyManagerFormBean());
    ...
    public ActionForward create_survey(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        SurveyManagerFormBean formBean = (SurveyManagerFormBean) surveyForm.get("ehrweb");
