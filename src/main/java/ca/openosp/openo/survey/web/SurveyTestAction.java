...
import ca.openosp.openo.common.model.SurveyTestData;
import ca.openosp.openo.common.model.SurveyTestInstance;
...
public class SurveyTestAction extends DispatchAction {
    ...
    public ActionForward test(ActionMapping mapping, ActionForm af, HttpServletRequest request, HttpServletResponse response) {
        ...
        ca.openosp.openo.common.model.Survey surveyObj = surveyManager.getSurvey(String.valueOf(formBean.getId()));
