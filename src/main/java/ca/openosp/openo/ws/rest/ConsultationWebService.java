...
import ca.openosp.openo.common.dao.BORNPathwayMappingDao;
...
import ca.openosp.openo.common.model.BORNPathwayMapping;
...
import ca.openosp.openo.ws.rest.conversion.ConsultationRequestConverter;
import ca.openosp.openo.ws.rest.conversion.ConsultationRequestExtConverter;
import ca.openosp.openo.ws.rest.conversion.ConsultationResponseConverter;
import ca.openosp.openo.ws.rest.conversion.ConsultationServiceConverter;
import ca.openosp.openo.ws.rest.conversion.DemographicConverter;
import ca.openosp.openo.ws.rest.conversion.DocumentConverter;
import ca.openosp.openo.ws.rest.conversion.ProfessionalSpecialistConverter;
import ca.openosp.openo.ws.rest.to.AbstractSearchResponse;
import ca.openosp.openo.ws.rest.to.GenericRESTResponse;
import ca.openosp.openo.ws.rest.to.ReferralResponse;
import ca.openosp.openo.ws.rest.to.model.ConsultationAttachment;
import ca.openosp.openo.ws.rest.to.model.ConsultationAttachmentTo1;
...
import ca.openosp.openo.ws.rest.to.model.ConsultationRequestTo1;
import ca.openosp.openo.ws.rest.to.model.ConsultationResponseSearchResult;
import ca.openosp.openo.ws.rest.to.model.ConsultationResponseTo1;
import ca.openosp.openo.ws.rest.to.model.FaxConfigTo1;
import ca.openosp.openo.ws.rest.to.model.LetterheadTo1;
...
public class ConsultationWebService extends AbstractServiceImpl {
    ...
    private void getDocuments(List<EDoc> edocs, boolean attached, List<ConsultationAttachmentTo1> attachments) {
        for (EDoc edoc : edocs) {
            String url = "ca/openosp/openo/documentManager/ManageDocument.do?method=display&doc_no=" + edoc.getDocId();
