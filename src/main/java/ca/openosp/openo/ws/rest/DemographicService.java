...
import ca.openosp.openo.ehrweb.DemographicSearchHelper;
import ca.openosp.openo.ws.rest.conversion.AllergyConverter;
import ca.openosp.openo.ws.rest.conversion.DemographicContactFewConverter;
import ca.openosp.openo.ws.rest.conversion.DemographicConverter;
import ca.openosp.openo.ws.rest.conversion.MeasurementConverter;
import ca.openosp.openo.ws.rest.conversion.ProfessionalSpecialistConverter;
import ca.openosp.openo.ws.rest.conversion.ProviderConverter;
import ca.openosp.openo.ws.rest.conversion.WaitingListNameConverter;
import ca.openosp.openo.ws.rest.to.AbstractSearchResponse;
import ca.openosp.openo.ws.rest.to.OscarSearchResponse;
import ca.openosp.openo.ws.rest.to.model.DemographicContactFewTo1;
...
import ca.openosp.openo.ws.rest.to.model.DemographicSearchRequest.SORTDIR;
import ca.openosp.openo.ws.rest.to.model.DemographicSearchRequest.SORTMODE;
import ca.openosp.openo.ws.rest.to.model.DemographicSearchResult;
...
import ca.openosp.openo.ws.rest.to.model.StatusValueTo1;
import ca.openosp.openo.ws.rest.to.model.WaitingListNameTo1;
