...
import ca.openosp.openo.ws.rest.to.RSSResponse;
...
public class RSSFeedService extends AbstractServiceImpl {
    ...
    public RSSResponse getRSS(@QueryParam("key") String key, @QueryParam("startPoint") String startPoint, @QueryParam("numberOfRows") String numberOfRows, @Context HttpServletRequest request) {
