...
import ca.openosp.openo.common.dao.AppointmentSearchDao;
...
import ca.openosp.openo.common.model.AppointmentSearch;
...
import ca.openosp.openo.ehrweb.PatientListApptBean;
import ca.openosp.openo.ehrweb.PatientListApptItemBean;
import ca.openosp.openo.ws.rest.conversion.AppointmentConverter;
import ca.openosp.openo.ws.rest.conversion.AppointmentStatusConverter;
import ca.openosp.openo.ws.rest.conversion.AppointmentTypeConverter;
import ca.openosp.openo.ws.rest.conversion.BillingDetailConverter;
import ca.openosp.openo.ws.rest.conversion.LookupListItemConverter;
import ca.openosp.openo.ws.rest.conversion.NewAppointmentConverter;
import ca.openosp.openo.ws.rest.conversion.ScheduleCodesConverter;
import ca.openosp.openo.ws.rest.to.AbstractSearchResponse;
import ca.openosp.openo.ws.rest.to.AppointmentExtResponse;
import ca.openosp.openo.ws.rest.to.ProviderApptsCountResponse;
import ca.openosp.openo.ws.rest.to.ProviderPeriodAppsResponse;
import ca.openosp.openo.ws.rest.to.SchedulingResponse;
import ca.openosp.openo.ws.rest.to.model.AppointmentExtTo;
import ca.openosp.openo.ws.rest.to.model.AppointmentSearchTo1;
import ca.openosp.openo.ws.rest.to.model.AppointmentStatusTo1;
import ca.openosp.openo.ws.rest.to.model.AppointmentTo1;
import ca.openosp.openo.ws.rest.to.model.BillingDetailTo1;
import ca.openosp.openo.ws.rest.to.model.NewAppointmentTo1;
import ca.openosp.openo.ws.rest.to.model.ProviderApptsCountTo;
import ca.openosp.openo.ws.rest.to.model.ProviderPeriodAppsTo;
import ca.openosp.openo.ws.rest.to.model.ScheduleTemplateCodeTo;
import ca.openosp.openo.ws.rest.to.model.SearchConfigTo1;
