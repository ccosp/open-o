...
public interface SecuserroleDao {
    ...
    void saveAll(List<Secuserrole> list);
    ...
    Secuserrole findById(Integer id);

    List<Secuserrole> findByExample(Secuserrole instance);

    List<Secuserrole> findByProperty(String propertyName, Object value);

    List<Secuserrole> findByProviderNo(Object providerNo);

    List<Secuserrole> findByRoleName(Object roleName);

    List<Secuserrole> findByOrgcd(Object orgcd, boolean activeOnly);

    List<Secuserrole> searchByCriteria(StaffForm staffForm);

    List<Secuserrole> findByActiveyn(Object activeyn);
