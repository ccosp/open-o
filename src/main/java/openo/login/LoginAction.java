...
import openo.util.AlertTimer;
import openo.util.CBIUtil;
import openo.util.ParameterActionForward;
...
public final class LoginAction extends DispatchAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        boolean ajaxResponse = request.getParameter("ajaxResponse") != null
                ? Boolean.valueOf(request.getParameter("ajaxResponse"))
                : false;
