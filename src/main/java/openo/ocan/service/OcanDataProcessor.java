...
import openo.ocan.domain.client.AnswerGroup;
import openo.ocan.domain.client.OCANClientSelfAssessment;
import openo.ocan.domain.staff.CCommunityTreatmentOrder;
import openo.ocan.domain.staff.CIfYesPleaseIndicateTheAreasWhereYouHaveConcernsCheckAllThatApply;
import openo.ocan.domain.staff.CMedicalConditionsCheckAllThatApply;
import openo.ocan.domain.staff.COtherContact;
import openo.ocan.domain.staff.CPsychiatricHistory;
import openo.ocan.domain.staff.CWhichOfTheFollowingDrugsHaveYouUsedCheckAllThatApply;
import openo.ocan.domain.staff.OCANStaffAssessment;
import openo.ocan.domain.submission.Action;
import openo.ocan.domain.submission.ActionList;
import openo.ocan.domain.submission.AddictionTypeList;
import openo.ocan.domain.submission.AdditionalElements;
import openo.ocan.domain.submission.ClientAddress;
import openo.ocan.domain.submission.ClientCapacity;
import openo.ocan.domain.submission.ClientContact;
import openo.ocan.domain.submission.ClientID;
import openo.ocan.domain.submission.ClientName;
import openo.ocan.domain.submission.ClientOHIP;
import openo.ocan.domain.submission.ClientRecord;
import openo.ocan.domain.submission.ConcernAreaList;
import openo.ocan.domain.submission.DiagnosticList;
import openo.ocan.domain.submission.DiscrimExpList;
import openo.ocan.domain.submission.DoctorContact;
import openo.ocan.domain.submission.Domain;
import openo.ocan.domain.submission.DrinkAlcohol;
import openo.ocan.domain.submission.DrugUse;
import openo.ocan.domain.submission.DrugUseList;
import openo.ocan.domain.submission.FormalHelpNeed;
import openo.ocan.domain.submission.FormalHelpRecvd;
import openo.ocan.domain.submission.ImmigExpList;
import openo.ocan.domain.submission.InformalHelpRecvd;
import openo.ocan.domain.submission.LegalStatusList;
import openo.ocan.domain.submission.MISFunction;
import openo.ocan.domain.submission.MedicalConditionList;
import openo.ocan.domain.submission.MedicationDetail;
import openo.ocan.domain.submission.MedicationList;
import openo.ocan.domain.submission.NeedRating;
import openo.ocan.domain.submission.OCANDomains;
import openo.ocan.domain.submission.OCANSubmissionFile;
import openo.ocan.domain.submission.OCANSubmissionRecord;
import openo.ocan.domain.submission.ObjectFactory;
import openo.ocan.domain.submission.OrganizationRecord;
import openo.ocan.domain.submission.OtherAgencyContact;
import openo.ocan.domain.submission.OtherIllnessList;
import openo.ocan.domain.submission.OtherPractitionerContact;
import openo.ocan.domain.submission.PresentingIssue;
import openo.ocan.domain.submission.PresentingIssueList;
import openo.ocan.domain.submission.Program;
import openo.ocan.domain.submission.PsychiatristContact;
import openo.ocan.domain.submission.ReasonForAssessment;
import openo.ocan.domain.submission.Referral;
import openo.ocan.domain.submission.ReferralList;
import openo.ocan.domain.submission.RiskUnemploymentList;
import openo.ocan.domain.submission.SafetyToSelfRiskList;
import openo.ocan.domain.submission.ServiceOrg;
import openo.ocan.domain.submission.SideEffectsDetailList;
import openo.ocan.domain.submission.SymptomList;
import openo.ocan.domain.submission.TimeLivedInCanada;
