...
package openo.oscarBilling.MSP;
        ...
        try {
            ...
            if (rs != null) {
                while (rs.next()) {
                    ...
                    //    referralDoc = "000000";
                    //    hcFlag = "";
                    //    referral = openo.SxmlMisc.getXmlContent(rs.getString("content"),"<xml_referral>","</xml_referral>");
                    //    hcType = openo.SxmlMisc.getXmlContent(rs.getString("content"),"<hctype>","</hctype>");
                    //    m_review = openo.SxmlMisc.getXmlContent(rs.getString("content"),"<mreview>","</mreview>");
                    ...
                    //   else{
                    //		 demoSex = openo.SxmlMisc.getXmlContent(rs.getString("content"),"<demosex>","</demosex>");
                    //		 hcFlag = "H";
                    ...
                    //    referralDoc = openo.SxmlMisc.getXmlContent(rs.getString("content"),"<rdohip>","</rdohip>");
