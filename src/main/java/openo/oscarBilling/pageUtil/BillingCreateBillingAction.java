...
package openo.oscarBilling.pageUtil;
...
import openo.oscarBilling.pageUtil.BillingBillingManager.BillingItem;
...
public class BillingCreateBillingAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        bean = (BillingSessionBean) request.getSession().getAttribute("billingSessionBean");
