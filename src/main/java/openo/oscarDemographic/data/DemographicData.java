...
package openo.oscarDemographic.data;
...
public class DemographicData {
    ...
    public static String getAge(Demographic d) {
        if (openo.util.StringUtils.empty(d.getYearOfBirth()) || openo.util.StringUtils.empty(d.getMonthOfBirth()) || openo.util.StringUtils.empty(d.getDateOfBirth())) {
            return "";
        }
