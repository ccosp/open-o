...
import openo.oscarEncounter.oscarMeasurements.data.LabMeasurements;
import openo.oscarEncounter.oscarMeasurements.data.Measurements;
import openo.oscarReport.data.DemographicSets;
...
public class CihiExportAction extends DispatchAction {
    ...
    public ActionForward unspecified(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (!Util.checkDir(tmpDir)) {
            ...
            MiscUtils.getLogger().error("Error! Cannot write to TMP_DIR - Check openo.properties or dir permissions. Using " + tmpDir);
        }
