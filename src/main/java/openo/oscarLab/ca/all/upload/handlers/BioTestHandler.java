...
import openo.oscarLab.ca.all.upload.RouteReportResults;
...
public class BioTestHandler implements MessageHandler {
    ...
    public String parse(LoggedInInfo loggedInInfo, String serviceName, String fileName, int fileId, String ipAddr) {
        ...
        try {
            ...
            for (i = 0; i < messages.size(); i++) {
                ...
                openo.oscarLab.ca.all.parsers.MessageHandler msgHandler = Factory.getHandler(String.valueOf(routeResults.segmentId));
    ...
    private void updateLabStatus(int n) {
        ...
        for (int k = 0; k < infos.size() && n > 0; k++) {
            ...
            if (info.getResultStatus() == null || !info.getResultStatus().equals("A")) {
                openo.oscarLab.ca.all.parsers.MessageHandler h = Factory.getHandler("" + info.getLabNumber());
                int i = 0;
                int j = 0;
                String resultStatus = "";
    ...
    private boolean isDuplicate(LoggedInInfo loggedInInfo, String msg) {
        ...
        openo.oscarLab.ca.all.parsers.MessageHandler h = Factory.getHandler("BIOTEST", msg);
        //if final
