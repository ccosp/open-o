...
package openo.oscarLab.ca.bc.PathNet;
...
import openo.oscarLab.ca.bc.PathNet.HL7.Message;
        ...
        if (connection.Open(username, password)) {
            ...
            if (messages != null) {
                ...
                try {
                    ...
                    logger.error("Error - openo.PathNet.Contorller - Message: " + ex.getMessage() + " = " + ex.toString());
                }
