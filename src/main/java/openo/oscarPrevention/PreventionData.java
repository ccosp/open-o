...
public class PreventionData {
    ...
    public static openo.oscarPrevention.Prevention getLocalandRemotePreventions(LoggedInInfo loggedInInfo, Integer demographicId) {
        openo.oscarPrevention.Prevention prevention = getPrevention(loggedInInfo, demographicId);
    ...
    public static openo.oscarPrevention.Prevention getPrevention(LoggedInInfo loggedInInfo, Integer demoNo) {
        DemographicManager demographicManager = SpringUtils.getBean(DemographicManager.class);
        Demographic dd = demographicManager.getDemographic(loggedInInfo, demoNo);
        ...
        openo.oscarPrevention.Prevention p = new openo.oscarPrevention.Prevention(sex, dob);
    ...
    public static openo.oscarPrevention.Prevention addRemotePreventions(LoggedInInfo loggedInInfo, openo.oscarPrevention.Prevention prevention, Integer demographicId) {
