...
public class ProgramDao extends HibernateDaoSupport {
    ...
    public Integer getProgramIdByProgramName(String programName) {
        ...
        List<Program> programs = (List<Program>) getHibernateTemplate().find("FROM Program p WHERE p.name = ? ORDER BY p.id ", programName);
    	if(!programs.isEmpty()) {
    ...
    public List<Program> getAllPrograms() {
        @SuppressWarnings("unchecked")
        List<Program> rs = (List<Program>) getHibernateTemplate().find("FROM Program p WHERE p.type != ? ORDER BY p.name ", Program.COMMUNITY_TYPE);
    ...
    public Program getProgramBySiteSpecificField(String value) {
        ...
        @SuppressWarnings("unchecked")
        List<Program> results = (List<Program>) getHibernateTemplate().find("from Program p where p.siteSpecificField = ?", new Object[]{value});
    ...
    public Program getProgramByName(String value) {
        ...
        @SuppressWarnings("unchecked")
        List<Program> results = (List<Program>) getHibernateTemplate().find("from Program p where p.name = ?", new Object[]{value});
    ...
    public List<Integer> getRecordsAddedAndUpdatedSinceTime(Integer facilityId, Date date) {
		@SuppressWarnings("unchecked")
		List<Integer> programs = (List<Integer>) getHibernateTemplate().find("select distinct p.id From Program p where p.facilityId = ? and p.lastUpdateDate > ?  ",facilityId, date);
    ...
    public List<Integer> getRecordsByFacilityId(Integer facilityId) {
		@SuppressWarnings("unchecked")
		List<Integer> programs = (List<Integer>) getHibernateTemplate().find("select distinct p.id From Program p where p.facilityId = ? ",facilityId);
