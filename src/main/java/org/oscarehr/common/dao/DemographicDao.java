...
public class DemographicDao extends HibernateDaoSupport implements ApplicationEventPublisherAware {
   ...
   */
	...
	public List<String> getRosterStatuses() {
		List<String> results = (List<String>) getHibernateTemplate().find("SELECT DISTINCT d.RosterStatus FROM Demographic d where d.RosterStatus != '' and d.RosterStatus != 'RO' and d.RosterStatus != 'TE' and d.RosterStatus != 'FS'");
		return results;
	}
	...
	public List<Demographic> getDemographicByRosterStatus(String rosterStatus, String patientStatus) {
		...
		@SuppressWarnings("unchecked")
		List<Demographic> rs = (List<Demographic>) getHibernateTemplate().find(queryStr,new Object[]{rosterStatus, patientStatus});
	...
	public List<Demographic> getActiveDemographicAfter(Date afterDatetimeExclusive) {
		...
		rs = afterDatetimeExclusive!=null ? (List<Demographic>) getHibernateTemplate().find(q, afterDatetimeExclusive) : (List<Demographic>) getHibernateTemplate().find(q);
