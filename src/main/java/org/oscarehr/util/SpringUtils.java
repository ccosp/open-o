...
public class SpringUtils {
	...
	public static <T> T getBean(Class<?> clazz) {
		...
		logger.error("OSCAR className" + className);
		 if (applicationContext == null) {
		...
		// If the bean is not found by class name, try by type
	 ...
	 */
	/**
	 * Attempts to find a Spring bean based of the specified class. This method
	 * first attempts to load a bean
	 * following the default Spring auto-naming conventions (de-capitalizing class
	 * simple name). In case the bean with
	 * this name can't be found, the method returns the first available bean of this
	 * class.
	 * <p/>
	 * Such logic is required in order to enable this method to lookup components
	 * from legacy contexts. "Older" beans seems to
	 * have identifiers hard-coded in the bean definition file, while "newer" bean
	 * identifiers are auto-generated by Spring based on the
	 * annotations.
	 * 
	 * @param clazz
	 ...
	 * @SuppressWarnings("unchecked")
	 * public static <T> T getBean(Class<?> clazz) {
	 * // legacy code - I wonder if it's necessary since we are looking up a bean
	 * based directly on the class name anyways
	 * // but to keep legacy logic working properly attempt to locate component
	 * based on the Spring conventions
	 * String className = WordUtils.uncapitalize(clazz.getSimpleName());
