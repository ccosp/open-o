 ...
 * @author rjonasz
 */
public class ConsultationAttachHRMReports {
    ...
    public ConsultationAttachHRMReports(String providerNumberToAttach, String demographicNumberToAttach, String consultationIdToAttach, String[] hrmReportsToAttach) {
    ...
    public void attach() {
        ...
        List<HRMDocumentToDemographic> oldList = hrmDocumentToDemographicDao.findHRMDocumentsAttachedToConsultation(consultationId);
    ...
    public static void attachHRMReportConsult(String providerNo, String hrmDocumentNumber, String consultationId) {
    	...
    	consultDoc.setRequestId(Integer.parseInt(consultationId));
