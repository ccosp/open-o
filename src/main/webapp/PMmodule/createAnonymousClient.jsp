...
<%@ page import="ca.openosp.openo.PMmodule.web.CreateAnonymousClientAction" %>
...
<%
    ...
    if (programId == 0) {
        ...
        demographic = CreateAnonymousClientAction.generateAnonymousClient(loggedInInfo.getLoggedInProviderNo(), programId);
    }
