...
<form method="post" name="docDescriptionForm" action="displayDocumentDescriptionTemplate.jsp">
    <div id="usefault" style="<%=providerNo==null? "visibility:hidden" : ""%>">
        <input type="checkbox" name="useclinicdefault" <%=clinicDefault == true ? "checked='checked'" : ""%>
               id="useclinicdefault" onclick="checkClinicDefault()"><bean:message
            key="provider.setDocumentDescriptionTemplate.useClinicDefault"/>
    </div>
    <% if (providerNo == null) {%>
    ...
    <table id="docTypeTable">
        ...
        <tr>
            <td>
                <bean:message key="provider.setDocumentDescriptionTemplate.Description"/>:
            </td>
            <td>
    ...
    <table style="visibility:hidden" id="tblDesc">
        <tr>
            <th align="left"><bean:message key="provider.setDocumentDescriptionTemplate.DescriptionShortcut"/></th>
            <th align="left"><bean:message key="provider.setDocumentDescriptionTemplate.Description"/></th>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><input type="button"
                                   value="<bean:message key="provider.setDocumentDescriptionTemplate.Add" />"
                                   id="addDescription" onclick="adddocDescription()">
                <input type="button" value="<bean:message key="provider.setDocumentDescriptionTemplate.Update" />"
                       id="updateDescription" onclick="updatedocDescription()">
                <input type="button" value="<bean:message key="provider.setDocumentDescriptionTemplate.Delete" />"
