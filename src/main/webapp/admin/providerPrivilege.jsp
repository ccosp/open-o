...
<%@ page import="ca.openosp.openo.common.model.SecPrivilege" %>
<%@ page import="ca.openosp.openo.common.dao.SecPrivilegeDao" %>
<%@ page import="ca.openosp.openo.common.model.SecObjectName" %>
<%@ page import="ca.openosp.openo.common.dao.SecObjectNameDao" %>
<%@ page import="ca.openosp.openo.common.dao.SecObjectNameDaoImpl" %>
<%@ page import="ca.openosp.openo.common.model.ProviderData" %>
<%@ page import="ca.openosp.openo.common.dao.ProviderDataDao" %>
<%@ page import="ca.openosp.openo.common.model.SecObjPrivilege" %>
<%@ page import="ca.openosp.openo.common.model.SecObjPrivilegePrimaryKey" %>
<%@ page import="ca.openosp.openo.common.dao.SecObjPrivilegeDao" %>
