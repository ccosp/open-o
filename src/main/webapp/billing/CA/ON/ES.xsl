            ...
            <body>
                ...
                <table border="0" width="100%" cellspacing="1" cellpadding="1" id="Report-ID">
                    ...
                    <tr>
                        ...
                        <td class="dataBlack">:
                            <xsl:value-of select="REPORT/REPORT-DTL/REPORT-AS-OF-DATE"/>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" width="100%" cellspacing="1" cellpadding="1" id="Group-ID">
                    <tr>
                        <td width="30%" align="left" class="dataBlack">GROUP (<xsl:value-of
                ...
                <table border="0" width="100%" cellspacing="1" cellpadding="1" ID="Member">
                    <xsl:for-each select="REPORT/GROUP/PROVIDER/MEMBER-DTL">
                        <tr>
                            <td width="30%" align="left" class="dataBlack">
                                <xsl:value-of select="MEMBER-TYPE"/>
                            </td>
                            <td class="dataBlack">:
                                <xsl:value-of select="MEMBER-TYPE-TOTAL"/>
                            </td>
                        </tr>
                    </xsl:for-each>
                    <tr>
                        <td width="30%" align="left" class="dataBlack">TOTAL MEMBERS</td>
                        <td class="dataBlack">:
                            <xsl:value-of select="REPORT/GROUP/PROVIDER/TOTAL-DTL/MEMBER-TOTAL"/>
                        </td>
                    </tr>
                </table>
