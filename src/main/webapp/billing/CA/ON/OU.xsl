    ...
    <xsl:template match="/">
        <html>
            <body>
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="1" id="Report-ID"
                       style="font-family:Arial;font-size:10pt">
                    <tr>
                        <td width="25%" align="left" class="dataBlack">REPORT ID</td>
                        <td class="dataBlack">:
                            <xsl:value-of select="REPORT/REPORT-DTL/REPORT-ID"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%" align="left" valign="top" class="dataBlack">REPORT DATE</td>
                        <td class="dataBlack">:
                            <xsl:value-of select="REPORT/REPORT-DTL/REPORT-DATE"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%" align="left" valign="top" class="dataBlack">REPORT PERIOD</td>
                        <td class="dataBlack">:
                            <xsl:value-of select="REPORT/REPORT-DTL/REPORT-PERIOD-START"/> TO
                            <xsl:value-of select="REPORT/REPORT-DTL/REPORT-PERIOD-END"/>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="1" id="Group-ID">
                    <tr>
                        <td width="25%" align="left" valign="top" class="dataBlack">GROUP (<xsl:value-of
                                select="REPORT/GROUP/GROUP-DTL/GROUP-TYPE"/>)
                        </td>
                        <td class="dataBlack">:
                            <xsl:value-of select="REPORT/GROUP/GROUP-DTL/GROUP-ID"/> -
                            <xsl:value-of select="REPORT/GROUP/GROUP-DTL/GROUP-NAME"/>
                        </td>
                    </tr>
                </table>
                <p></p>
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="1" id="Provider-ID">
                    <tr>
                        ...
                        <td class="dataBlack">:
                            <xsl:value-of select="REPORT/GROUP/PROVIDER/PROVIDER-DTL/PROVIDER-NUMBER"/> -
                        ...
                        <xsl:for-each select="./SERVICE-DTL1">
                            <tr>
                                <td width="12%" align="left" valign="top" class="dataBlack">
                                    <xsl:value-of select="../PATIENT-DTL/PATIENT-LAST-NAME"/>
                                </td>
                                <td width="12%" align="left" valign="top" class="dataBlack">
                                    <xsl:value-of select="../PATIENT-DTL/PATIENT-FIRST-NAME"/>
                                </td>
                                <td width="10%" align="left" valign="top" class="dataBlack">
                                    <xsl:value-of select="../PATIENT-DTL/PATIENT-HEALTH-NUMBER"/>
                                </td>
                                <td width="10%" align="left" valign="top" class="dataBlack">
                                    <xsl:value-of select="../PATIENT-DTL/PATIENT-BIRTHDATE"/>
                                </td>
                                <td width="5%" align="left" valign="top" class="dataBlack">
                                    <xsl:value-of select="../PATIENT-DTL/PATIENT-SEX"/>
                                </td>
                                <td width="10%" align="left" valign="top" class="dataBlack">
                                ...
                                <td width="10%" align="left" valign="top" class="dataBlack">$
                                    <xsl:value-of select="./SERVICE-AMT"/>
                                </td>
                            </tr>
                        </xsl:for-each>
                    </xsl:for-each>
