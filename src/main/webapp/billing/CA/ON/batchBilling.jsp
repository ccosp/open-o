        ...
        <form name="serviceform" method="post" action="BatchBill.do" class="form-inline">
            ...
            <div class="span2">
                ...
                <select name="provider" class="span2" onChange="jumpMenu('window',this)">
                    ...
                    <option value="all"
                            <%=providerview.equals("all") ? "selected" : ""%>><bean:message
                            key="billing.batchbilling.msgAllProvider"/></option>
            ...
            <div class="span3">
                ...
                <select id="service_code" class="span3" name="service_code">
                    <option value="all" <%=servicecode.equals("all") ? "selected" : ""%>><bean:message
                            key="billing.batchbilling.msgAllServiceCode"/></option>
                    <%
                ...
                <td colspan="7">
                    ...
                    <div class="span4">
                        ...
                        <input type="button" class="btn" onclick="return askFirst('remove');"
                               value="<bean:message key="billing.batchbilling.btnRemove"/>">
                    </div>
                </td>
            </tr>
