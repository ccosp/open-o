...
<html>
<head>
    <title><bean:message key="oscarEncounter.noteBrowser.title"/> - <oscar:nameage
    ...
    <table>
        ...
        <tr>
            <td align="left" valign="top" width="50%">
                ...
                <bean:message key="oscarEncounter.noteBrowser.msgViewStatus"/> <select id="selviewstatus"
                                                                                       name="selviewstatus"
                                                                                       onchange="ReLoadDoc()">
                <option value="all"
                        <%=viewstatus.equalsIgnoreCase("all") ? "selected" : ""%>><bean:message
                        key="oscarEncounter.noteBrowser.msgAll"/></option>
                <option value="deleted"
                        <%=viewstatus.equalsIgnoreCase("deleted") ? "selected" : ""%>><bean:message
                        key="oscarEncounter.noteBrowser.msgDeleted"/></option>
                <option value="active"
                        <%=viewstatus.equalsIgnoreCase("active") ? "selected" : ""%>><bean:message
                        key="oscarEncounter.noteBrowser.msgPublished"/></option>
            </select>

                <bean:message key="oscarEncounter.noteBrowser.msgSortDate"/>
                <select id="selsortorder" name="selsortorder" onchange="ReLoadDoc()">
                    <option value="Content"
                            <%=sortorder.equalsIgnoreCase("Content") ? "selected" : ""%>><bean:message
                            key="oscarEncounter.noteBrowser.msgContent"/></option>
                    <option value="Observation"
                            <%=sortorder.equalsIgnoreCase("Observation") ? "selected" : ""%>><bean:message
                            key="oscarEncounter.noteBrowser.msgObservation"/></option>
                    <option value="Update"
                            <%=sortorder.equalsIgnoreCase("Update") ? "selected" : ""%>><bean:message
                            key="oscarEncounter.noteBrowser.msgUpdate"/></option>

                </select>
                <fieldset>
                    <legend><bean:message key="oscarEncounter.noteBrowser.msgView"/>:</legend>
                ...
                <div id="docbuttons">
                    ...
                    <input type="button" value="<bean:message key="oscarEncounter.noteBrowser.msgAddTickler"/>"
                           onclick="AddTickler();"> <%}%>
                    <input type="button" value="<bean:message key="oscarEncounter.noteBrowser.msgAnnotate"/>"
                           onclick="DocAnnotation()">
                    <input type="button" value="<bean:message key="oscarEncounter.noteBrowser.msgEdit"/>"
                           onclick="DocEdit();">
                    <input type="button" value="<bean:message key="oscarEncounter.noteBrowser.msgDelete"/>"
                           onclick="DeleteDoc();">
                    <div id="refilebutton">
                        <input type="button" value="<bean:message key="oscarEncounter.noteBrowser.msgRefile"/>"
                               onclick="RefileDoc();">
                    ...
                    <input type="button" value="<bean:message key="oscarEncounter.noteBrowser.msgUndelete"/>"
                           onclick="UnDeleteDoc();">
                    <%}%>
                </div>
            ...
            <td valign="top">
                ...
                <fieldset>
                    <legend><bean:message key="oscarEncounter.noteBrowser.encounterNote"/></legend>
