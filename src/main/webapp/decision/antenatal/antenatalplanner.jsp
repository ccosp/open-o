...
<jsp:useBean id="risks" class="openo.decision.DesAntenatalPlannerRisks_99_12" scope="page"/>
<jsp:useBean id="checklist" class="openo.decision.DesAntenatalPlannerChecklist_99_12" scope="page"/>
