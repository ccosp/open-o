...
<%@ page
        import="java.util.*, oscar.*, ca.openosp.openo.oscarDemographic.data.ProvinceNames, ca.openosp.openo.oscarDemographic.pageUtil.Util, ca.openosp.openo.oscarWaitingList.WaitingList" %>
<%@ page
                ...
                <form method="post" id="adddemographic" name="adddemographic" action="demographicaddarecord.jsp"
                    ...
                    <table id="addDemographicTbl" bgcolor="#EEEEFF">
                        ...
                        <tr>
                            ...
                            <td id="renewDateLbl" align="right"><b>*<bean:message
