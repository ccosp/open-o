    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr valign="top">
            <td align="center">
                ...
                <label for="p1_birthRemarksr3"><bean:message
                        key="oscarEncounter.formRourke2009.formNoConcerns"/></label>&nbsp;
            </td>
            ...
            <table id="pt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p1_patencyOfAnus1w" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td valign="top"><bean:message key="oscarEncounter.formRourke2020.formSpine"/>**/<bean:message
                            key="oscarEncounter.formRourke2020.formPatencyOfAnus"/>**
                    </td>
                </tr>
                <tr>
            ...
            <table id="immt11" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><b><a href="javascript:showNotes()"
                              ...
                              onMouseOut="hideLayer()">
                        <bean:message
                                key="oscarEncounter.formRourke2020.formImmunizationHemoglobinopathyScreen"/></a></b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="padding-left: 4px;"><bean:message
                            key="oscarEncounter.formRourke2020.formImmunizationIfHepatitis"/>:
                    </td>
                </tr>
                <tr>
