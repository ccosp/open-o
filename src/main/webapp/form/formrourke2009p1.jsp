...
<div style="display:block; width:100%; text-align:center; background-color: #FFFFFF;"><img alt="copyright"
                                                                                           ...
                                                                                           <bean:message
                                                                                                   key="oscarEncounter.formRourke2009.formCopyRight"/>')"
        ...
        <tr valign="top">
            <td align="center"><bean:message
                ...
                <input type="radio" id="p1_birthRemarksr1"
                    ...
                    <%= props.getProperty("p1_birthRemarksr1", "") %>><bean:message
                        key="oscarEncounter.formRourke2009.formPremature"/>&nbsp;
                <input type="radio" id="p1_birthRemarksr2"
                       name="p1_birthRemarksr2" onclick="onCheck(this,'p1_birthRemarksr')"
                    <%= props.getProperty("p1_birthRemarksr2", "") %>><bean:message
                        key="oscarEncounter.formRourke2009.formHighRisk"/>&nbsp;<br>
                <input type="radio" id="p1_birthRemarksr3"
                       name="p1_birthRemarksr3" onclick="onCheck(this,'p1_birthRemarksr')"
                    <%= props.getProperty("p1_birthRemarksr3", "") %>><bean:message
                        key="oscarEncounter.formRourke2009.formNoConcerns"/>&nbsp;
                ...
                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tr>
                        ...
                        <td nowrap align="center">
                            ...
                            <bean:message key="oscarEncounter.formRourke2009.form1min"/><select name="c_APGAR1min">
                            <option <%= props.getProperty("c_APGAR1min", "").equals("") || props.getProperty("c_APGAR1min", "").equals("-1") ? "selected='selected'" : ""%>
                                    value="-1"><bean:message key="oscarEncounter.formRourke2009.formNotSet"/></option>
                            <% for (Integer idx = 0; idx <= 10; ++idx) { %>
                            <option <%= props.getProperty("c_APGAR1min", "").equals(idx.toString()) ? "selected='selected'" : ""%>
                                    value="<%=idx%>"><%=idx%>
                            </option>
                            <%}%></select><br>
                            <bean:message key="oscarEncounter.formRourke2009.form5min"/><select name="c_APGAR5min">
        ...
        <td colspan="3">
            <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                <tr>
                    ...
                    <td class="edcol" valign="top">X</td>
                    <td class="edcol" valign="top" colspan="2"><bean:message
                            key="oscarEncounter.formRourke2009.formNotDone"/></td>
                </tr>
                <tr>
