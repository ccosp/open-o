...
<%@ page import="openo.form.FrmRourke2017Record" %>
...
<div style="width:100%;"><img alt="copyright" src="graphics/rourke2017Banner.png" onMouseOver="popLayer('<bean:message
            ...
            <table id="immt31" style="font-size: 9pt;" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <rourke:discussionRadioSelect sectionName="p3_HbvAntibodies" formProperties="<%=props%>"
                                                  showNoOption="<%=false%>" showNotDiscussedOption="<%=true%>"/>
                    <td colspan="7"><b><a href="javascript:showNotes()" onMouseOver="popLayer('<bean:message
                            key="oscarEncounter.formRourke2006.footnote1"/>')" onMouseOut="hideLayer()">
