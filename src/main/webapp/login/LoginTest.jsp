...
<%@page import="ca.openosp.openo.ehrutil.SpringUtils,ca.openosp.openo.common.dao.PropertyDao,ca.openosp.openo.common.model.Property" %>
<%@page import="ca.openosp.openo.common.service.AcceptableUseAgreementManager" %>
<%@page import="ca.openosp.openo.ehrutil.SpringUtils,ca.openosp.openo.PMmodule.dao.ProviderDao,ca.openosp.openo.common.model.Provider" %>
<%
...
<div style="text-align:center;">
    ...
    <form method="post" action="<c:out value="${pageContext.request.contextPath}/login/recordLogin.do"/>">
        ...
        <input type="submit" onclick="document.forms[0].submit.value='accept';return true;"
               value="<bean:message key="provider.login.btn.agree"/>">
        <input type="submit" onclick="document.forms[0].submit.value='refuse';return true;"
               value="<bean:message key="provider.login.btn.refuse"/>">
    </form>
</div>
</body>
</html>