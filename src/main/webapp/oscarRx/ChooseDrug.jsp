...
<%@ page import="java.util.*,oscar.oscarRx.data.*,oscar.oscarRx.pageUtil.*, ca.openosp.openo.OscarProperties" %>
...
<logic:present name="RxSessionBean" scope="session">
    <bean:define id="bean" type="ca.openosp.openo.oscarRx.pageUtil.RxSessionBean" name="RxSessionBean" scope="session"/>
