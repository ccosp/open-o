...
--%>
<%@ page
        import="java.util.*,oscar.oscarRx.data.*,java.text.DateFormatSymbols,oscar.oscarRx.pageUtil.*,java.io.*,org.apache.xmlrpc.*, ca.openosp.openo.util.StringUtils,java.util.Random" %>
