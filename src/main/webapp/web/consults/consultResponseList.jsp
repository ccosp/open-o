...
<div ng-show="consultReadAccess" class="col-lg-12">
    ...
    <table ng-table="tableParams" show-filter="false" class="table">
        ...
        <tr ng-repeat="consult in $data" ng-mouseover="consult.$selected=true" ng-mouseout="consult.$selected=false"
            ...
            <td><a
                    ng-click="editConsult(consult)" class="hand-hover"><bean:message key="global.edit" bundle="ui"/></a>
            </td>
            ...
            <td data-title="'<bean:message key="consult.list.header.referringDoctor" bundle="ui"/>'"
            ...
            <td data-title="'<bean:message key="consult.list.header.mrp" bundle="ui"/>'" sortable="'Provider'">
            ...
            <td data-title="'<bean:message key="consult.list.header.responseDate" bundle="ui"/>'"
