        ...
        <form>
            <div class="form-group">
                ...
                <select name="disReason" id="disReason" ng-model="$ctrl.discon.reason">
                    <option value="adverseReaction"><bean:message
                    ...
                    <option value="drugInteraction"><bean:message
                    ...
                    <option value="enteredInError"><bean:message
                            key="oscarRx.discontinuedReason.EnteredInError"/></option>
                    <option value="patientRequest"><bean:message
                            key="oscarRx.discontinuedReason.PatientRequest"/></option>
                    <option value="prescribingError"><bean:message
