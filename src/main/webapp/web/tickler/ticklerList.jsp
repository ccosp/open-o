...
<div ng-show="ticklerReadAccess" class="col-lg-12">
    ...
    <table ng-table="tableParams" show-filter="false" class="table">
        ...
        <tr ng-repeat="tickler in $data">
            ...
            <td ng-show="ticklerWriteAccess">
                <a ng-click="editTickler(tickler)" class="hand-hover noprint"><bean:message key="global.edit"
                                                                                            bundle="ui"/></a>
            </td>
            <td ng-show="!ticklerWriteAccess">
        ...
        <tr>
            <td colspan="11" class="white">
                <a ng-click="checkAll()"><bean:message key="tickler.list.checkAll" bundle="ui"/></a> - <a
                    ng-click="checkNone()"><bean:message key="tickler.list.checkNone" bundle="ui"/></a> &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp;
                <button class="btn btn-default" name="button" type="button" ng-click="addTickler()"><bean:message
                        key="tickler.list.add" bundle="ui"/></button>
                <button class="btn btn-default" type="button" ng-click="completeTicklers()"><bean:message
                        key="tickler.list.complete" bundle="ui"/></button>
                <button class="btn btn-default" type="button" ng-click="deleteTicklers()"><bean:message
                        key="tickler.list.delete" bundle="ui"/></button>
            </td>
        </tr>
        </tfoot>
